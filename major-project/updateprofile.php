    ...
    <div class="form-container">
        ...
        <form method="POST" action="updateprofile.php">
            ...
            <div class="button-container">
                ...
                <a href="profile.php" class="cancel-button" style="text-decoration: none; padding: 10px 30px; border-radius: 4px; color: white; display: inline-block; background-color: #d9534f; text-align: center; margin-left: 100px">Cancel</a>
            </div>
        </form>
    </div>
</body>
